          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[48rem]">
              ...
              <div className="md:pr-32">
                ...
                <p className="text-lg text-slate-400 mb-8 md:mt-6 md:mb-0">
                  In AI BountyHub, every AI prompt has its value. Post your needs, or answer others' challenges, and let cryptocurrency be the reward for your knowledge!
                </p>
              </div>
              {/* Logos */}
